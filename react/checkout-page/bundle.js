...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BookStore = __webpack_require__(159);
	...
	var InputExample = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement('input', { type: 'text', value: this.state.name, onChange: this.handleChange });
	  }
	});

	_reactDom2.default.render(_react2.default.createElement(_BookStore2.default, null), document.getElementById('root'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ShippingDetails = __webpack_require__(161);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BookList = _react2.default.createClass({
	     ...
	     _renderBook: function _renderBook(book) {
	          return _react2.default.createElement(
	               'div',
	               { className: 'checkbox', key: book.id },
	               _react2.default.createElement(
	                    'label',
	                    null,
	                    _react2.default.createElement('input', { type: 'checkbox', value: book.name, onChange: this.handleSelectedBooks }),
	                    ' ',
	                    book.name,
	                    ' -- ',
	                    book.author
	     ...
	     handleSelectedBooks: function handleSelectedBooks(e) {
	          var selectedBooks = this.state.selectedBooks;
	          var index = selectedBooks.indexOf(e.target.value);

	          if (e.target.checked) {
	               if (index === -1) selectedBooks.push(e.target.value);
	          } else {
	          ...
	          return _react2.default.createElement(
	               ...
	               _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                         ...
	                         _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Full Name', value: this.state.fullName, onChange: function onChange(e) {
	                                   return _this.handleChange(e, 'fullName');
	                              } })
	                    ),
	                    _react2.default.createElement(
	                         'div',
	                         { className: 'form-group' },
	                         _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Contact number', value: this.state.contactNumber, onChange: function onChange(e) {
	                                   return _this.handleChange(e, 'contactNumber');
	                              } })
	                    ),
	                    _react2.default.createElement(
	                         'div',
	                         { className: 'form-group' },
	                         _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Shipping Address', value: this.state.shippingAddress, onChange: function onChange(e) {
	                                   return _this.handleChange(e, 'shippingAddress');
	                              } })
	                    ),
	                    _react2.default.createElement(
	                         'div',
	                         ...
	                         _react2.default.createElement(
	                              'button',
	                              { className: 'btn btn-success', type: 'submit', ref: 'submit' },
	                              'Submit'
	                         )
	                    )
	               ),
	                    ...
	                    _react2.default.createElement(
	                         ...
	                         _react2.default.createElement(
	                              ...
	                              _react2.default.createElement(
	                                   'label',
	                                   null,
	                                   _react2.default.createElement('input', { type: 'radio', checked: this.state.deliveryOption === "Primary", value: 'Primary', onChange: this.handleChange }),
	                         ...
	                         _react2.default.createElement(
	                              ...
	                              _react2.default.createElement(
	                                   'label',
	                                   null,
	                                   _react2.default.createElement('input', { type: 'radio', checked: this.state.deliveryOption === "Normal", value: 'Normal', onChange: this.handleChange }),
	                                   'Normal -- 3-4 days'
	                              )
	                         ),
	                         _react2.default.createElement(
